...
func (c *Client) addOperationListBillEstimateInputUsageModificationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(&smithyRpcv2cbor_serializeOpListBillEstimateInputUsageModifications{}, middleware.After)
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(&smithyRpcv2cbor_deserializeOpListBillEstimateInputUsageModifications{}, middleware.After)
	if err != nil {
		return err
	}
