...
func (c *Client) addOperationListBillEstimatesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(&smithyRpcv2cbor_serializeOpListBillEstimates{}, middleware.After)
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(&smithyRpcv2cbor_deserializeOpListBillEstimates{}, middleware.After)
	if err != nil {
		return err
	}
